  ...
  void handle_request(shared_ptr<Connection> connection) {
    ...
    async_read_until(connection->socket, *read_buffer, "\r\n",
      ...
      if (!ec) {
        ...
        string html = "<title>Hovedside</title><h1>Hilsen. Du har koblet deg opp til min enkle web-tjener</h1><ul>";
        html += "<li>" + message + "</li>";
...
int main() {
  ...
  cout << "Starting echo server" << endl
       << "Connect in a terminal with: telnet localhost 80. Type 'exit' to end connection." << endl;
